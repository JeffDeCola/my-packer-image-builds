#!/bin/sh -e
# my-packer-image-builds jeffs-gce-image-ubuntu-2204 pull-private-repos-for-jeff.sh
...
echo "mkdir /home/jeff/services"
[ -d /home/jeff/services ] || runuser -l jeff -c 'mkdir /home/jeff/services'
echo " "

echo "git clone hello-go-deploy-gce.git"
echo "You must cd into the directory in same command"
runuser -l jeff -c 'cd /home/jeff/services; git clone git@github.com:JeffDeCola/hello-go-deploy-gce.git'
echo " "
