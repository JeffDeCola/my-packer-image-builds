#!/bin/sh -e
# security-prepend-proxmox-universal-key-to-authorized-keys-jeff.sh

echo " "
echo "*****************************************************************************"
echo "* security-prepend-proxmox-universal-key-to-authorized-keys-jeff.sh (START) *"
...
echo "Prepend proxmox_universal key onto authorized_keys"
cat /tmp/proxmox_universal.pub >> /home/jeff/.ssh/authorized_keys
echo " "
...
echo "* security-prepend-proxmox-universal-key-to-authorized-keys-jeff.sh (END) *"
echo "***************************************************************************"
echo " "
