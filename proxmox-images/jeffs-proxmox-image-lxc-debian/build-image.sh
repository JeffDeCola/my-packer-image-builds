#!/bin/sh -e
# my-packer-image-builds jeffs-proxmox-lxc-debian build-image.sh
#
# # Usage:
...
echo "The goal is to create a custom image on proxmox using packer."
echo " "
...
then
    ...
    packer validate \
        -var "image_name=proxmox-image-lxc-debian" \
